...
exports.default = exports.TAG_ISO_14443_4 = exports.TAG_ISO_14443_3 = exports.KEY_TYPE_B = exports.KEY_TYPE_A = exports.CONNECT_MODE_DIRECT = exports.CONNECT_MODE_CARD = void 0;
...
const TAG_ISO_14443_3 = exports.TAG_ISO_14443_3 = 'TAG_ISO_14443_3'; // ISO/IEC 14443-3 tags
const TAG_ISO_14443_4 = exports.TAG_ISO_14443_4 = 'TAG_ISO_14443_4'; // ISO/IEC 14443-4 tags
...
class Reader extends _events.default {
  ...
  async loadAuthenticationKey(keyNumber, key) {
    ...
    // INS
    0x00,
    // P1: Key Structure (0x00 = Key is loaded into the reader volatile memory.)
    keyNumber,
    // P2: Key Number (00h ~ 01h = Key Location. The keys will disappear once the reader is disconnected from the PC)
    key.length,
    // Lc: Length of the key (6)
  ...
  async read(blockNumber, length, blockSize = 4, packetSize = 16, readClass = 0xff) {
    ...
    const packet = Buffer.from([readClass,
    // Class
    0xb0,
    // Ins
    blockNumber >> 8 & 0xFF,
  ...
  async write(blockNumber, data, blockSize = 4) {
    ...
    const packetHeader = Buffer.from([0xff,
    // Class
    0xd6,
    // Ins
    0x00,
...
var _default = exports.default = Reader;